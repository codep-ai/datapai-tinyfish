...
export interface Broker {
  ...
  signupUrl: string;
  /**
   * Specific pricing/fees page URL — used by TinyFish scanner to monitor for fee changes.
...
export const AU_BROKERS: Broker[] = [
  ...
  },
  {
    ...
    commissionOptions: null,
    accountMin: "$0",
    hasAUStocks: true, hasUSStocks: true, hasOptions: false, hasETFs: true, hasCrypto: true,
    internationalMarkets: "US stocks (NYSE / NASDAQ)",
    chessSponsored: true, hasSMSF: true, hasIRA: null, hasSolo401k: null, hasJointAccount: true,
    hasFractionalShares: false, hasMobileApp: true, hasDesktopPlatform: true,
    note: "CHESS sponsored. Frequent traders get first 10 trades/month free. Crypto trading available",
  },
  {
    id: "bell-direct",
    name: "Bell Direct",
  ...
  },
  {
    ...
    hasFractionalShares: false, hasMobileApp: true, hasDesktopPlatform: false,
    note: "CHESS sponsored. Best for existing Westpac customers. *$4.95 fee subject to conditions — verify on website",
  },
  {
    id: "moomoo-au",
    name: "moomoo",
    tagline: "Commission-free ASX & US stocks, app-first",
    market: "AU",
    regulator: "ASIC",
    url: "https://www.moomoo.com/au",
    signupUrl: "https://www.moomoo.com/au/welcome",
    feePageUrl: "https://www.moomoo.com/au/help/charges",
    trustpilotUrl: "https://au.trustpilot.com/review/moomoo.com",
    commissionStocks: "$0* (conditions apply)",
    commissionETFs: "$0*",
    commissionOptions: null,
    accountMin: "$0",
    hasAUStocks: true, hasUSStocks: true, hasOptions: false, hasETFs: true, hasCrypto: false,
    internationalMarkets: "US stocks (NYSE / NASDAQ)",
    chessSponsored: false, hasSMSF: false, hasIRA: null, hasSolo401k: null, hasJointAccount: false,
    hasFractionalShares: false, hasMobileApp: true, hasDesktopPlatform: true,
    note: "Custodian model (not CHESS sponsored). *$0 brokerage subject to conditions — verify on website",
  },
];
